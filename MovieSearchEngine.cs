...
public class MovieSearchEngine
{
    private readonly string _indexDir = "~/opt/homebrew/bin/MovieSearcher/MoviesDirectory.json";
    ...
    public void AddMovieToIndex(IEnumerable<Movie> movies)
    {
        ...
        var config = new IndexWriterConfig(LuceneVersion.LUCENE_30, analyzer);
 ...
 IndexReader reader = IndexReader.Open(indexDirectory);
        ...
        var parser = new QueryParser(LuceneVersion.LUCENE_30, "title", new StandardAnalyzer(LuceneVersion.LUCENE_30));
